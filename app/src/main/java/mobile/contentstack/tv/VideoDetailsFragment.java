...
public class VideoDetailsFragment extends DetailsFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSelectedMovie = (Movies) getActivity().getIntent().getSerializableExtra(DetailsActivity.MOVIE);
    ...
    private void initializeBackground(Movies data) {
        ...
        Glide.with(getActivity()).load(Movies.BG+data.getCardImageUrl())
                .asBitmap()
                .centerCrop()
    ...
    private void setupDetailsOverviewRow() {
        ...
        Glide.with(getActivity())
                .load(Movies.PREVIEW+mSelectedMovie.getCardImageUrl())
                .centerCrop()
                .error(R.drawable.default_background)
    ...
    private void setupRelatedMovieListRow() {
        ...
        LinkedHashMap<String, List<Movies>> csMovies = Movies.getLinked_movies();
        List<Movies> relatedMovies = csMovies.get("new_release");
        ArrayObjectAdapter listRowAdapter = new ArrayObjectAdapter(new CardPresenter());
        assert relatedMovies != null;
        for(Movies movies: relatedMovies){ listRowAdapter.add(movies); }
        HeaderItem header = new HeaderItem(0, "You May Also like");
